package br.com.joselaine.orgs.recycler.adapter
...
class ListaDeProdutosAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun vincula(produto: Produto) {
            val nome = itemView.findViewById<TextView>(R.id.campo_nome)
            val descricao = itemView.findViewById<TextView>(R.id.campo_descricao)
            val preco = itemView.findViewById<TextView>(R.id.preco)
            nome.text = produto.nome
            descricao.text = produto.descricao
            "R$ ${produto.preco.toPlainString()}".also { preco.text = it }
        }
    }
